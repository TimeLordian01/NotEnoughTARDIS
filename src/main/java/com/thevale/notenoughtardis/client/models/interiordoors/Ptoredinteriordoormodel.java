package com.thevale.notenoughtardis.client.models.interiordoors;// Made with Blockbench 3.7.5
...
import com.thevale.notenoughtardis.client.renders.exteriors.PtoredRender;
import com.thevale.notenoughtardis.client.renders.exteriors.ShalkaRender;
...
public class Ptoredinteriordoormodel extends EntityModel<Entity> implements IInteriorDoorRenderer {
    ...
    public ResourceLocation getTexture() {
        ...
        ResourceLocation TEXTURE = new ResourceLocation("notenoughtardis","textures/interiordoor/ptoredinterior.png");
        return TEXTURE;
    }
