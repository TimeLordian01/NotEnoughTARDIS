...
import com.thevale.notenoughtardis.client.models.exteriors.FiveExterior;
import com.thevale.notenoughtardis.tileentities.exteriors.FiveTile;
...
public class FiveRender extends ExteriorRenderer<FiveTile> {
    public static final ResourceLocation TEXTURE = new ResourceLocation("notenoughtardis", "textures/exteriors/fiveexterior.png");
