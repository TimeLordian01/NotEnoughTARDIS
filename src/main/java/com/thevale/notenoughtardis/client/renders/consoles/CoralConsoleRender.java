...
import com.thevale.notenoughtardis.client.models.consoles.CoralConsole;
...
public class CoralConsoleRender extends TileEntityRenderer<CoralConsoleTile> {
	...
	public static final ResourceLocation TEXTURE = new ResourceLocation(com.thevale.notenoughtardis.NotEnoughTardis.MODID, "textures/consoles/coralconsole.png");
