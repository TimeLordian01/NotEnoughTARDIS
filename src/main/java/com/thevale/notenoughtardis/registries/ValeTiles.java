...
public class ValeTiles {
    public static final DeferredRegister<TileEntityType<?>> TILES = DeferredRegister.create(ForgeRegistries.TILE_ENTITIES, com.thevale.notenoughtardis.NotEnoughTardis.MODID);
    //Exteriors
