...
public class ElevatorTile extends ExteriorTile {

    public static final AxisAlignedBB RENDER = new AxisAlignedBB(-1, -1, -1, 2, 2, 2);
    public ElevatorTile() { super(ValeTiles.exterior_elevator); }

    public ElevatorTile(TileEntityType<?> tileEntityTypeIn) {
